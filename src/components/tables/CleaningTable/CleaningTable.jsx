...
import { Form } from "components/inputs/Forms/ClickSaveForm/ClickSaveForm";
import { TextFieldSimple } from "components/inputs";
import Table from "../Table/Table";

/**
 * A table designed to be able to accomadate the cleaning of contacts upon import
 * @param {Array} bad_contacts something
 * @param {Int} clean_contacts something 
 * @param {Function} duplicates something
 * @param {Array} importContact something
 * @param {Int} revertImports something
 * @param {Function} updateImport something
 * @param {Int} viewImports something
 * @param {Function} total_warnings something
 * @returns {React.ReactElement} a CleaningTable component
 */
